For those who want to host their passwords on a remote server, such as a NAS, you can try using the [BashPass-Remote](https://github.com/AntonVanAssche/BashPass-Remote) project.
